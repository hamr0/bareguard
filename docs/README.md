...
| [PRD](01-product/bareguard-prd.md) | Unified design spec — the thirteen primitives, complete-mediation architecture, the 6-step eval order, audit/budget specs, migration plan + future-feature candidates (§19). |
